...
import com.stock.platform.common.ResponseCode;
...
public class PreconditionsUtil {
    ...
    public static void checkNotNull(Object reference, String errorMessage) {
        try {
            ...
            throw new BusinessException(ResponseCode.BAD_REQUEST.getCode(), errorMessage);
        }
    }
     ...
     *
     * @param reference the object reference to check
     * @param responseCode the response code to use if the check fails
     * @throws BusinessException if {@code reference} is null
     */
    public static void checkNotNull(Object reference, ResponseCode responseCode) {
        try {
     ...
     * @throws BusinessException if {@code expression} is false
     */
    public static void checkArgument(boolean expression, ResponseCode responseCode) {
        try {
    ...
    public static void checkState(boolean expression, String errorMessage) {
        try {
            ...
            throw new BusinessException(ResponseCode.INTERNAL_SERVER_ERROR.getCode(), errorMessage);
        }
    }
}
